...
function About() {
    return (
        <div>
            ...
            <h3>This project is a web application that allows users to navigate through the characters of the animated series <b>"Rick and Morty"</b> and interact with them. 
