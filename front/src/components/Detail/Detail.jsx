        ...
        <div className={styles.detailAbsolute}>
            ...
            {character.name? (
                <>
                    ...
                    <button className={styles.episodeBtn} onClick={handleEpisodes}><svg xmlns="http://www.w3.org/2000/svg" height="2.5em" viewBox="0 0 640 512" fill='white'><path d="M64 64V352H576V64H64zM0 64C0 28.7 28.7 0 64 0H576c35.3 0 64 28.7 64 64V352c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V64zM128 448H512c17.7 0 32 14.3 32 32s-14.3 32-32 32H128c-17.7 0-32-14.3-32-32s14.3-32 32-32z"/></svg></button>

                    { isOpen &&
                        <div className={styles.episodeBox}>
                        <h4 className={styles.episodeText}>EPISODES</h4>
                        <div className={styles.episodes}>{ character.episode.map((ep) => <h6 className={styles.episodeBubble}>{episodeSplitter(ep)}</h6>)}</div>
                    </div>
                    }
                </>
            ): (
